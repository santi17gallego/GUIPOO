...
public class EliminarPermisos extends FlowPane{
    ...
    public EliminarPermisos() {
        ...
        Label nombreProcesolb = new Label("Eliminar permisos");
        Label descripcionProcesolb = new Label("Opción para eliminar permisos a determinado usuario.");
...
//        vbox.getChildren().add(new Label());
        ...
        btnguardar.setOnAction((event) -> {
            ...
            if (admin.eliminarPermisos(campo.getText(), permisosUp)) {
                Alert alerta = new Alert(Alert.AlertType.CONFIRMATION);
                alerta.setContentText("Acción exitosa.");
                alerta.show();
            } else {
                Alert alerta = new Alert(Alert.AlertType.ERROR);
                alerta.setContentText("Error al eliminar permiso.");
                alerta.show();
            }
        });
